...
export const AppMenu = ({ chapterId, next, prev, target }: AppMenuProps) => {
      ...
      <ul className={S.options}>
        <li className={S.option}>
          <button
            data-enabled={!!prev}
            className={S.button}
            onClick={() => navigate(`/chapter/?id=${prev}`)}
          >
            <IconChevronLeft />
          </button>
        </li>
        ...
        <li className={S.option}>
          <button
            data-enabled={!!next}
            className={S.button}
            onClick={() => navigate(`/chapter/?id=${next}`)}
          >
            <IconChevronRight />
          </button>
        </li>
