import { collectChapterList } from './../../../../src/commands/download/providers/readnovelfull/collect/chapter-list.ts';
...
describe('ReadNovelFull - Extract the list of chapters from an html', async () => {
  const path = TEST_ASSETS_HTML_PATH
  const filename = testPages['readnovelfull-chapterList'].targetName
